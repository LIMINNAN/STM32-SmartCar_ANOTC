...
/*****************************************************************************************/
extern void DrawSineWave(float freq,float am) ;
extern void DrawSquareWave(float freq, float am);
extern void DrawTriangleWave(float freq, float am);
extern void DrawSawtoothWave(float freq, float am);
extern void autochange(float *freq,float *am);
/*****************************************************************************************/
#endif
