...
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void AnoPTv8SendCheck(uint8_t Destination_Address, uint8_t id, uint8_t sc, uint8_t ac)
{
	uint8_t _cnt = 0;
	...
	if (bufindex >= 0)
	{
		...
		AnoPTv8TxBuf[bufindex].dataBuf.frame.ddevid = Destination_Address;
...
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void AnoPTv8SendDevInfo(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int bufindex = AnoPTv8GetFreeTxBufIndex();
...
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void AnoPTv8SendStr(uint8_t Destination_Address, uint8_t string_color, char *str)
{
	uint8_t _cnt = 0;
	int bufindex = AnoPTv8GetFreeTxBufIndex();
...
void AnoPTv8SendValStr(uint8_t Destination_Address, float val, char *str)
{
	uint8_t _cnt = 0;
	int bufindex = AnoPTv8GetFreeTxBufIndex();
...
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void AnoPTv8SendParNum(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int bufindex = AnoPTv8GetFreeTxBufIndex();
...
void AnoPTv8SendParVal(uint8_t Destination_Address, uint16_t parid)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendParInfo(uint8_t Destination_Address, uint16_t parid)
{
	uint8_t _cnt = 0;
...
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void AnoPTv8SendCmdNum(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendCmdInfo(uint8_t Destination_Address, uint16_t cmd)
{
	uint8_t _cnt = 0;
...
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void AnoPTv8SendFCD01(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int16_t temp_data;
...
void AnoPTv8SendFCD02(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int16_t temp_data;
...
void AnoPTv8SendFCD03(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int16_t temp_data;
...
void AnoPTv8SendFCD04(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int16_t temp_data;
...
void AnoPTv8SendFCD05(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int32_t temp_data_32;
...
void AnoPTv8SendFCD06(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendFCD07(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int16_t temp_data;
...
void AnoPTv8SendFCD08(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int32_t temp_data_32;
...
void AnoPTv8SendFCD09(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int16_t temp_data;
...
void AnoPTv8SendFCD0A(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendFCD0B(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendFCD0C(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendFCD0D(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
	int16_t temp_data;
...
void AnoPTv8SendFCD0E(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendFCD20(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendFCD21(uint8_t Destination_Address)
{
	uint8_t _cnt = 0;
...
void AnoPTv8SendBuf(uint8_t Destination_Address, uint8_t fid, uint8_t *buf, uint16_t len)
{
	uint8_t _cnt = 0;
