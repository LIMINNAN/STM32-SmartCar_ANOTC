...
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int32_t parLis_PID[ANOPTV8_PARNUM];
const _st_par_info AnoParInfoList[ANOPTV8_PARNUM]=
{
	//参数最小值，参数最大值，参数值指针，参数名称，参数介绍
	{0,65535,&parLis_PID[0],"tPid_pos_P","位置式：P"},
	{0,65535,&parLis_PID[1],"tPid_pos_I","位置式：I"},
	{0,65535,&parLis_PID[2],"tPid_pos_D","位置式：D"},
...
const _st_cmd_info AnoCmdInfoList[ANOPTV8_CMDNUM] =
{
    //CID0	CID1	CID2	VAL0	VAL1	VAL2	VAL3	VAL4	VAL5	VAL6	VAL7	CmdName			CmdInfo				CmdFun
			{{0x01,	0xA0,	0x01,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00,	0x00},	"LEDRTOG",		"控制LED",			AnoPTv8CmdFun_UserCmd1},
